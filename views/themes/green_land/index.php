...
<head>
	...
	<?=link_tag('views/themes/green_land/style.css')?>
				...
				<div class="row align-items-center">
					<div class="col-md-5 col-sm-12 col-xs-12">
						<ul class="list-unstyled top-left">
							<li><h5 class="font-weight-bold text-warning"><?=strtoupper(__session('school_name'))?></h5></li>
					...
					<div class="col-md-4 col-xs-12 text-md-left mb-2 mt-2">
						...
						<ul class="list-unstyled">
							...
							<?php if (NULL !== __session('twitter') && __session('twitter')) { ?>
								<li class="float-left"><a href="<?=__session('facebook')?>" title="Twitter"><i class="fa fa-twitter social-icon twitter" aria-hidden="true"></a></i></li>
							<?php } ?>
