...
if (! function_exists('general')) {
	function general() {
		return [
			...
			[
				'setting_group' => 'general',
				'setting_variable' => 'google_map_api_key',
				'setting_default_value' => 'AIzaSyDmiycFxzYZ37FOwA4wqSbL3z2YvIYIArw',
				'setting_access_group' => 'public',
				'setting_description' => 'API Key Google Map'
			],
			[
				'setting_group' => 'general',
				'setting_variable' => 'latitude',
				'setting_default_value' => '-6.2407311',
				'setting_access_group' => 'public',
				'setting_description' => 'Latitude'
			],
			[
				'setting_group' => 'general',
				'setting_variable' => 'longitude',
				'setting_default_value' => '106.9972892',
				'setting_access_group' => 'public',
				'setting_description' => 'Longitude'
			],
			[
				'setting_group' => 'general',
	...
	function media() {
		return [
			...
			[
				...
				'setting_access_group' => 'public',
				'setting_description' => 'Tinggi Cover Album Photo'
			],
			[
				'setting_group' => 'media',
				...
				'setting_access_group' => 'public',
				'setting_description' => 'Lebar Cover Album Photo'
			],
			[
				'setting_group' => 'media',
