...
class Dashboard extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['google_map_api_key'] = (NULL !== __session('google_map_api_key') && __session('google_map_api_key')) ? TRUE : FALSE;
		$this->vars['latitude'] = (NULL !== __session('latitude') && __session('latitude')) ? TRUE : FALSE;
		$this->vars['longitude'] = (NULL !== __session('longitude') && __session('longitude')) ? TRUE : FALSE;
	...
	public function print_sessions() {
		if (__session('user_type') !== 'super_user') redirect(base_url());
		echo '<pre>';
