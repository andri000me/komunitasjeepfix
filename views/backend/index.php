...
<!-- sidebar-collapse -->
<body class="hold-transition skin-purple sidebar-mini <?=$this->session->sidebar_collapse ? 'sidebar-collapse':''?>">
	<div class="wrapper">
					...
					<ul class="nav navbar-nav">
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<li><a href="https://www.facebook.com/groups/cmssekolahku" target="_blank"><i class="fa fa-facebook"></i> FORUM DSKUSI</a></li>
