			...
			<?php if (in_array('blog', __session('user_privileges'))) { ?>
				<li class="treeview <?=isset($blog) ? 'active':'';?>">
					...
					<ul class="treeview-menu">
						...
						<li <?=isset($welcome) ? 'class="active"':'';?>><a href="<?=site_url('blog/welcome');?>"><i class="fa fa-sign-out"></i> Sambutan <?=__session('_headmaster')?></a></li>
			...
			<?php if (in_array('admission', __session('user_privileges'))) { ?>
				<li class="treeview <?=isset($admission) ? 'active':'';?>">
					...
					<ul class="treeview-menu">
						...
						<li <?=isset($registrants) ? 'class="active"':'';?>><a href="<?=site_url('admission/registrants');?>"><i class="fa fa-sign-out"></i> Semua Pendaftar</a></li>
