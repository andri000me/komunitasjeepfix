...
<section class="content-header">
   <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-6">
         <h3 style="margin:0;"><i class="fa fa-sign-out text-green"></i> <span class="table-header"><?=isset($title) ? $title : ''?></span> <?=isset($sub_title) ? '<br><small style="margin-left:29px;">'.$sub_title.'</small>' : ''?></h3>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-6">
