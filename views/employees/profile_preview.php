                  ...
                  <form class="form-horizontal">
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=filter_var((string) $query->parent_school_status, FILTER_VALIDATE_BOOLEAN) ? 'Ya':'Tidak'?></p>
                           </div>
                        </div>
                     </div>
                  </form>
                  ...
                  <form class="form-horizontal">
                     <div class="box-body">
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=filter_var((string) $query->headmaster_license, FILTER_VALIDATE_BOOLEAN) ? 'Ya' : 'Tidak'?></p>
                           </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=filter_var((string) $query->braille_skills, FILTER_VALIDATE_BOOLEAN) ? 'Ya' : 'Tidak'?></p>
                           </div>
                        </div>
                        <div class="form-group">
                           <label for="sign_language_skills" class="col-sm-4 control-label">Keahlian Bahasa Isyarat</label>
                           <div class="col-sm-8">
                              <p class="form-control-static"><?=filter_var((string) $query->sign_language_skills, FILTER_VALIDATE_BOOLEAN) ? 'Ya' : 'Tidak'?></p>
                           </div>
                        </div>
                     </div>
                  </form>
