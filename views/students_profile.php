					 ...
					 <form class="form-horizontal">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
								  <input readonly="true" type="text" class="form-control" id="is_transfer" value="<?=$query->is_transfer ? (filter_var((string) $query->is_transfer, FILTER_VALIDATE_BOOLEAN) ? 'Pindahan' : 'Baru') : '';?>">
								</div>
							</div>
							<div class="form-group">
